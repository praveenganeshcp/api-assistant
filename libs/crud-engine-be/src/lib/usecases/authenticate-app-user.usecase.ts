...
@Injectable()
export class AuthenticateAppUserUsecase implements Usecase<AuthenticateAppUserUsecaseInput, AuthenticatedUser> {
    ...
    async execute(data: AuthenticateAppUserUsecaseInput): Promise<AuthenticatedUser> {
