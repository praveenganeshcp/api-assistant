...
import {
  CloudCodeEditorComponent,
  CloudCodeFunctionsListComponent,
...
export class ApplicationCloudCodeHostComponent implements OnInit {
  ...
  protected readonly requestHandlers$: Observable<CanBeNull<string[]>> =
    this.store.select(requestHandlersDataSelector);
